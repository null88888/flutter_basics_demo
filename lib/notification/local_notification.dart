...
Future<void> notificationMain() async {
  ...
  runApp(
    MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        NotificationHomePage.routeName: (_) => NotificationHomePage(notificationAppLaunchDetails),
...
class _NotificationHomePageState extends State<NotificationHomePage> {
              ...
              await flutterLocalNotificationsPlugin.zonedSchedule(
                  ...
                  const NotificationDetails(
                      android: AndroidNotificationDetails(
                          'full screen channel id', 'full screen channel name', 'full screen channel description',
  ...
  Future<void> _showNotificationCustomSound() async {
    ...
    await flutterLocalNotificationsPlugin.show(
        0, 'custom sound notification title', 'custom sound notification body', platformChannelSpecifics);
  }
  ...
  Future<void> _scheduleWeeklyTenAMNotification() async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails(
              'weekly notification channel id', 'weekly notification channel name', 'weekly notificationdescription'),
        ),
        androidAllowWhileIdle: true,
        uiLocalNotificationDateInterpretation: UILocalNotificationDateInterpretation.absoluteTime,
