...
import 'package:flutter_basics_demo/base_demo/http/network_imag_ewithout_auth.dart';
...
class _ImageProviderResolver {
  ...
  void resolve(ImageProvider provider) {
    ...
    if (_imageStream.key != oldImageStream?.key) {
      oldImageStream?.removeListener(_handleImageChanged as ImageStreamListener);
...
class _FadeInImageState extends State<FadeInImageWithoutAuth> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(FadeInImageWithoutAuth oldWidget) {
    ...
    if (widget.image != oldWidget.image || widget.placeholder != oldWidget.placeholder) _resolveImage();
  }
