...
class ShareSystemPage extends StatefulWidget {
  @override
  _ShareSystemPageState createState() => _ShareSystemPageState();
}

class _ShareSystemPageState extends State<ShareSystemPage> {
  ...
  Future<String> _writeByteToImageFile(ByteData byteData) async {
    ...
    File imageFile = new File("${dir!.path}/flutter/${DateTime.now().millisecondsSinceEpoch}.png");
