...
class _FlutterSlidableDemoState extends State<FlutterSlidableDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[GoWeb(pluginName: 'flutter_slidable')],
      ),
      body: ListView(
        children: <Widget>[
          renderItemType(title: 'SlidableBehindActionPane滑出效果', actionType: SlidableBehindActionPane()),
          renderItemType(title: 'SlidableScrollActionPane滑出效果', actionType: SlidableScrollActionPane()),
          renderItemType(title: 'SlidableDrawerActionPane滑出效果', actionType: SlidableDrawerActionPane()),
          renderItemType(title: 'SlidableStrechActionPane滑出效果', actionType: SlidableStrechActionPane()),
          Slidable(
  ...
  Widget renderItemType({required String title, required Widget actionType}) {
    return Slidable(
