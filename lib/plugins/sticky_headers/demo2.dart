...
class StickyHeadersDemo2 extends StatefulWidget {
  StickyHeadersDemo2({Key? key}) : super(key: key);

  @override
  _demoState createState() => _demoState();
}

class _demoState extends State<StickyHeadersDemo2> {
  List<String> imgs = [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[GoWeb(pluginName: 'sticky_headers')],
        ),
              ...
              return new Material(
                ...
                child: new StickyHeaderBuilder(
                            ...
                            child: new Opacity(
                              ...
                              child: new IconButton(
                                ...
                                onPressed: () => Scaffold.of(context)
                                    .showSnackBar(new SnackBar(content: new Text('Favorite #$index'))),
                              ),
                            ),
                          ),
                        ],
                  ...
                  content: new Container(
                    child: new Image.network(imgs[index], fit: BoxFit.cover, width: double.infinity, height: 200.0),
                  ),
                ),
              );
            }));
